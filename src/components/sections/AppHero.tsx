...
const StoreButton = memo(
	({ store, href, label, storeName }: StoreButtonProps) => {
		const GooglePlayIcon = () => (
			<svg aria-hidden="true" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg" className="w-8 h-8">
		...
		return (
			<a
				...
				className="group flex items-center gap-3 rounded-md border border-gray-200 bg-gray-50 px-5 py-3 transition-all duration-300 hover:bg-gray-100 hover:border-gray-300 shadow-sm"
			>
